...
const modules: ModuleState[] = [
  {
    ...
    type: 'habitat',
    location: 'habitat',
    position: { x: 2, y: 5, width: 5, height: 4 },
    atmosphere: 'yes',
    condition: 91,
    powerPriority: 1,
    breached: false,
  },
  {
    ...
    type: 'corridor',
    location: 'corridor',
    position: { x: 7, y: 6, width: 5, height: 2 },
    atmosphere: 'yes',
    condition: 94,
    powerPriority: 2,
    breached: false,
  ...
  },
  {
    ...
    type: 'storage',
    location: 'storage',
    position: { x: 8, y: 9, width: 4, height: 3 },
    atmosphere: 'yes',
    condition: 89,
    powerPriority: 3,
    breached: false,
  },
  {
    ...
    type: 'laboratory',
    location: 'laboratory',
    position: { x: 12, y: 4, width: 5, height: 4 },
    atmosphere: 'no',
    condition: 58,
    powerPriority: 2,
    breached: true,
  },
  {
    ...
    type: 'airlock',
    location: 'airlock',
    position: { x: 12, y: 9, width: 3, height: 3 },
    atmosphere: 'yes',
    condition: 96,
    powerPriority: 1,
    breached: false,
  },
  {
    ...
    location: 'solar-skid',
    position: { x: 17, y: 2, width: 5, height: 4 },
    atmosphere: 'no',
    condition: 82,
    powerPriority: 1,
    breached: false,
  },
  {
    ...
    position: { x: 17, y: 10, width: 5, height: 5 },
    atmosphere: 'no',
    condition: 93,
    powerPriority: 3,
    breached: false,
